...
export enum UniverseInput {
  ETHEREUM = "ETHEREUM",
  FUEL = "FUEL",
  SOLANA = "SOLANA",
}

export enum UniverseOutput {
  ETHEREUM = "ETHEREUM",
  FUEL = "FUEL",
  SOLANA = "SOLANA",
}
...
export class ArcanaVault extends Contract {
  ...
  declare functions: {
    ...
    deposit: InvokeFunction<
      [request: RequestInput, signature: string, chain_index: BigNumberish],
      void
    >;
    ...
    withdraw: InvokeFunction<
      [to: IdentityInput, asset_id: AssetIdInput, amount: BigNumberish],
      void
    >;
  };
